...
dataFilePath <- here::here("interactiveDataAveraging", "rawData") #### NEED TO CHANGE THIS TO FOLDER WITH RAW DATA ####
...
# Load the data --------------------------------------------------------
  ...
  cvPlotData <- reactive({
    ...
    if(noCond2()== 1){
      beatFileName <- paste(here::here("interactiveDataAveraging", "rawData"),
  ...
  respPlotData <- reactive({
    ...
    if(noCond2()== 1){
      breathFileName <- paste(here::here("interactiveDataAveraging", "rawData"),
    ...
    burstPlotData <- reactive({
      ...
      if(noCond2()== 1){
        burstFileName <- paste(here::here("interactiveDataAveraging", "rawData"),
